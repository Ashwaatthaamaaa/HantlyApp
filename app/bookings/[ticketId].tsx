...
export default function BookingDetailScreen() {
  ...
  const userCanChatWithAssigned = !isPartner && !!bookingData.companyId && !isCreated; // User direct chat only possible *after* creation
  const partnerCanChatWithAssigned = isPartner && !!bookingData.userId && !isCreated; // Partner direct chat only possible *after* creation
  const partnerCanInitiateChat = isPartner && isCreated && !!bookingData.userId; // Partner initiate button only on 'Created'
